...
func RefreshToken(oldToken, secret string, expiration time.Duration) (string, error) {
	...
	return GenerateToken(claims.UserID, claims.Email, claims.Roles, secret, expiration)
}
